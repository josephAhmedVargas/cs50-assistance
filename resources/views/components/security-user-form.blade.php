        ...
        <form action="{{ route('user-details.store')}}">
            ...
            <div class="sm:col-span-2 lg:w-xl space-y-4 md:w-md">
                ...
                <div class="">
                    ...
                    <input type="text" name="name" id="name" class="mb-5 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" disabled>
                </div>
                <div class="">
