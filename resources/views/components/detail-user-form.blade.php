        ...
        <form action="{{ route('user-details.store')}}">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="">
                    ...
                    <input  value="{{ old('staff_email', auth()->user()->details->staff_email) }}" type="text" name="staff_email" id="staff_mail" class="mb-5 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" disabled readonly>
                </div> 
